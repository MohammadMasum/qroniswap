...
import PoolBanner3 from './img/pools-banner-3.png';
    ...
    const list = [
        {
            ...
            button: {
                label: "Get started",
                url: "https://medium.com/@groniswap"
            },
            list: [
  ...
  return (
    <Section>
        ...
        <div className="container">
            {list && list.map((r, idx) =>(
            <BoxRow className="row g-5 align-items-center">
                <div className="col-lg-6">
                    <BoxContent>
                        ...
                        {r.button && <div className="button-area">
                            <a href={r.button.url} className="btn btn-gr-primary">{r.button.label}</a>
                        </div>       
                        }
                    </BoxContent>
                </div>
                <div className={`col-lg-6 ${r.banner_left ? 'order-lg-first' : ''}`}>
